...
const OrderOptions = ({ items, total, productId, quantity }) => {
  ...
  const handleCODOrder = async () => {
    ...
    try {
      await axios.post('https://farmer-final-bkp2.onrender.com/api/orders', payload, {
  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://farmer-final-bkp2.onrender.com/api/payment/create-order", payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      const options = {
        ...
        handler: async (response) => {
          // 3️⃣ Verify payment
          try {
            const verifyRes = await axios.post("https://farmer-final-bkp2.onrender.com/api/payment/verify-payment", {
