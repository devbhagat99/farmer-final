...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const res = await axios.get(`https://farmer-final-bkp2.onrender.com/api/products/${id}`);
        setProduct(res.data);
      } catch {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://farmer-final-bkp2.onrender.com/api/cart", {
    ...
    axios
      .get("https://farmer-final-bkp2.onrender.com/api/wishlist", {
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  useEffect(() => {
    ...
    const fetchRecommended = async () => {
      try {
        const res = await axios.get(`https://farmer-final-bkp2.onrender.com/api/products`);
  ...
  const toggleCart = async () => {
    ...
    try {
      await axios.post(
        `https://farmer-final-bkp2.onrender.com/api/cart/${exists ? "remove" : "add"}`,
  ...
  const toggleWishlist = async () => {
    ...
    try {
      await axios.post(
        `https://farmer-final-bkp2.onrender.com/api/wishlist/${exists ? "remove" : "add"}`,
